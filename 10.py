...
data = get_data("day10", int_parser)
print(part1(data))
...
print(part2([int(i) for i in test1.splitlines()]))
...
3
"""
print(part2([int(i) for i in test2.splitlines()]))
